    ...
    <div className="xl:w-2/5 lg:w-2/5  py-16 xl:rounded-bl rounded-tl rounded-tr xl:rounded-tr-none">
      <div className="xl:w-5/6 xl:px-0 px-8 mx-auto">
        ...
        <p className="text-xl text-white pb-8 leading-relaxed font-normal lg:pr-4">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus, incidunt nesciunt illo error dicta vel ducimus fugit odit ipsa nobis, recusandae nostrum eum soluta at iusto! Odio error placeat eos.
        </p>
        ...
        <div className="flex items-center">
          ...
          <p className="pl-4 text-white text-base">Info@thapaguruji.com</p>
        </div>
